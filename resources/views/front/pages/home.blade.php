...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Welcome to ')
@section('meta_tags')
          ...
          <article class="card article-card">
            <a href="{{ route('read_post', single_latest_post()->post_slug) }}">
              <div class="card-image">
                <div class="post-info"> <span class="text-uppercase">{{ date_formatter(now()) }}</span>
                ...
                <img loading="lazy" decoding="async" src="{{ asset('../storage/app/public/images/post_images/' . single_latest_post()->featured_image) }}" alt="" class="w-100">
              </div>
            </a>
  ...
  <div class="col-lg-12">
    <div class="widget">
      <div class="widget-body">
        <img loading="lazy" decoding="async" src="/front/images/author.png" alt="About Me" class="w-100 author-thumb-sm d-block">
        <h2 class="widget-title my-3">Scool</h2>
        <p class="mb-3 pb-2">Hello, I’m Scool. A Content writter, Developer and Story
          teller. Working as a Content writter at Infinitie Technologies</p>
      </div>
    </div>
  </div>
      ...
      <div class="widget-body">
        <div class="widget-list">
          ...
          <a class="media align-items-center" href="{{ route('read_post',$item->post_slug) }}">
            <img loading="lazy" decoding="async" src="" alt="" class="w-100">
