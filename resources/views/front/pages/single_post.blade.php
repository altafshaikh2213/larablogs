...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Welcome to Bloggers')
@section('meta_tags')
...
<div class="row">
    <div class="col-lg-8 mb-5 mb-lg-0">
        <article>
            <img loading="lazy" decoding="async" src="..../storage/app/public/images/post_images/{{$post->featured_image}}" alt="" class="w-100">
        ...
        <div class="widget-list mt-5">
            ...
            <a class="media align-items-center" href="{{ route('read_post',$item->post_slug) }}">
              <img loading="lazy" decoding="async" src="/storage/images/post_images/thumbnails/thumb_{{$item->featured_image}}" alt="" class="w-100">
                ...
                <div class="col-lg-12">
                    <div class="widget">
                        <div class="widget-body">
                            <img loading="lazy" decoding="async" src="/front/images/author.png" alt="About Me"
